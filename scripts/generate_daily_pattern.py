...
def generate_daily_pattern_graph(date1='2024-06-02', date2='2024-06-24'):
    """
    ...
    # 保存
    output_file = os.path.join(project_root, 'png', 'daily_battery_pattern.png')
...
if __name__ == '__main__':
    ...
    generate_daily_pattern_graph('2024-06-02', '2024-06-24')
    print('\n完了しました!')
