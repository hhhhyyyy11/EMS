...
\noindent
コスト削減は430kWhを基準とした差額を示す．負の値は430kWhより高コストであることを意味する．

\subsubsection{蓄電池容量に関する知見}

\begin{enumerate}
    \item \textbf{PV利用率の向上}：蓄電池容量の増加に伴いPV利用率が向上する．430kWhでは98.41\%（PV余剰4,578kWh），860kWhでは100\%（PV余剰0kWh）を達成した．

    \item \textbf{契約電力への影響}：430kWhでは契約電力205.73kW，860kWhでは221.56kWとなった．蓄電池容量を増やすことで，価格が安い時間帯により多くの電力を蓄電できるため，買電の集中度が高まり契約電力が増加した．

    \item \textbf{容量と経済性の関係}：430kWhから860kWhへの容量増加（+430kWh）により，PV利用率は98.41\%から100\%に向上し，買電量は3,812kWh削減されたが，年間コストは約39万円増加した．これは，電力量料金の削減効果（約5万円）よりも，契約電力増加（+15.83kW）による基本料金増加（約46万円）の影響が大きいためである．

    \item \textbf{最適容量の検討}：市場価格連動プランにおいては，蓄電池容量430kWhが860kWhよりも経済的に有利な結果となった．容量増加は必ずしもコスト削減につながらず，料金体系と運用戦略を考慮した最適容量の検討が重要である．
\end{enumerate}
