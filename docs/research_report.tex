...
蓄電池なしの場合にPV余剰が発生する理由は，PV発電と需要の時間パターンの不一致にある．PV発電は昼間（6:00〜18:00）に集中するが，需要は夜間にも発生する．蓄電池がなければ，昼間のPV発電が需要を上回る時間帯において余剰電力を蓄えられず，約22\%（63,000kWh）が捨てられる．蓄電池を導入することで，この余剰を充電し夜間に放電することが可能となり，PV利用率が向上する．860kWh以上の蓄電池容量があれば，年間を通じてPV余剰をすべて吸収でき，PV利用率100\%を達成できる．

以下の考察では，蓄電池860kWhの条件下での予測期間の影響を分析する．

元々の本システムは，予測期間を24時間としており，24時間とした場合に，PV発電が多い日において蓄電池が満充電に到達しない現象が見られた．PVエネルギーを今日蓄電することと明日蓄電することは，エネルギー的に同等であり，満充電まで蓄電する方が合理的ではないかと考えた．また，予測期間を24時間としているため，翌日のPV発電パターンを考慮できず，蓄電池の充電が抑制されている可能性があると考えた．そこで，予測期間を48時間先（96ステップ）に延長し，同一データで再度最適化を実施した．
