...
予測期間$H=96$（48時間）の条件下で，蓄電池容量$b_{\mathrm{F}}^{\max}$を0kWh（蓄電池なし），215kWh，430kWh，860kWh，1290kWh，1720kWhと変化させ，経済性への影響を評価した．
...
\begin{enumerate}
    ...
    \item \textbf{PV利用率の向上}：蓄電池容量の増加に伴いPV利用率が向上する．0kWhでは78.01\%，215kWhでは92.43\%，430kWhでは98.41\%，860kWh以上では100\%を達成した．
