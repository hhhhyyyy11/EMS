...
市場価格連動プラン，予測期間$H=96$（48時間）の条件下で，蓄電池容量$b_{\mathrm{F}}^{\max}$を0kWhから2000kWhの範囲で変化させ，経済性への影響を評価した．

\subsubsection{蓄電池容量と年間コストの関係}

表\ref{tab:capacity_comparison}に蓄電池容量別の年間コスト比較を示す．

\begin{table}[H]
\centering
\caption{蓄電池容量別の年間コスト比較（市場価格連動プラン，仮の値）}
\label{tab:capacity_comparison}
\begin{tabular}{rrrrrr}
\toprule
容量 [kWh] & 契約電力 [kW] & 買電量 [kWh] & PV利用率 [\%] & 年間コスト [円] & コスト削減 [円] \\
\midrule
0 & 280.00 & 560,000 & 95.0 & 17,500,000 & - \\
200 & 260.00 & 555,000 & 97.5 & 16,800,000 & 700,000 \\
400 & 245.00 & 552,000 & 99.0 & 16,200,000 & 1,300,000 \\
600 & 232.00 & 549,500 & 99.8 & 15,700,000 & 1,800,000 \\
860 & 221.56 & 547,990 & 100.0 & 15,396,972 & 2,103,028 \\
1000 & 218.00 & 547,500 & 100.0 & 15,300,000 & 2,200,000 \\
1500 & 210.00 & 547,000 & 100.0 & 15,050,000 & 2,450,000 \\
2000 & 205.00 & 546,800 & 100.0 & 14,900,000 & 2,600,000 \\
\bottomrule
\end{tabular}
\end{table}

\noindent
\textbf{注記}：860kWh以外の数値は仮の値であり，実際のシミュレーション結果に基づいて更新が必要である．

\subsubsection{蓄電池容量に関する知見}

\begin{enumerate}
    \item \textbf{PV利用率の向上}：蓄電池容量の増加に伴いPV利用率が向上し，600kWh以上で99.8\%以上を達成．860kWh以上では100\%を維持している．

    \item \textbf{契約電力の抑制}：蓄電池容量が大きいほど需要のピークカットが効果的に行われ，契約電力を抑制できる．

    \item \textbf{限界効用逓減}：蓄電池容量の増加に対するコスト削減効果は逓減する傾向がある．860kWhを超えると削減幅が小さくなり，設備投資対効果を考慮した最適容量の検討が必要である．

    \item \textbf{蓄電池なし（0kWh）との比較}：蓄電池860kWhの導入により，年間約210万円のコスト削減が可能である（仮の試算）．
\end{enumerate}

% TODO: 実際のシミュレーション結果を取得後，以下のグラフを追加する
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.8\textwidth]{../png/capacity_vs_cost.png}
% \caption{蓄電池容量と年間コストの関係}
