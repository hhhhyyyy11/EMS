...
予測期間$H=96$（48時間）の条件下で，蓄電池容量$b_{\mathrm{F}}^{\max}$を430kWh，860kWh，1290kWh，1720kWhと変化させ，経済性への影響を評価した．
...
\midrule
430 & 205.73 & 551,802 & 98.41 & 15,007,684 & - \\
860 & 221.56 & 547,990 & 100.0 & 15,396,972 & $+389,288$ \\
1290 & 226.95 & 547,976 & 100.0 & 15,549,018 & $+541,334$ \\
1720 & 232.94 & 547,815 & 100.0 & 15,715,245 & $+707,561$ \\
\bottomrule
\end{tabular}
\end{table}
...
容量 [kWh] & 契約電力 [kW] & 買電量 [kWh] & PV利用率 [\%] & 年間コスト [円] & コスト差 [円] \\
\midrule
430 & 189.84 & 551,201 & 98.41 & 15,354,276 & - \\
860 & 170.93 & 548,136 & 100.0 & 14,757,247 & $-597,029$ \\
1290 & 161.16 & 548,291 & 100.0 & 14,478,318 & $-875,958$ \\
1720 & 161.16 & 548,175 & 100.0 & 14,476,495 & $-877,781$ \\
\bottomrule
\end{tabular}
\end{table}

\noindent
コスト差は430kWhを基準とした差額を示す．正の値は430kWhより高コスト，負の値は430kWhより低コストであることを意味する．

\subsubsection{蓄電池容量に関する知見}

\begin{enumerate}
    \item \textbf{PV利用率の向上}：蓄電池容量の増加に伴いPV利用率が向上する．430kWhでは98.41\%（PV余剰4,578kWh），860kWh以上では100\%（PV余剰0kWh）を達成した．

    \item \textbf{料金プランによる契約電力への影響の違い}：
    \begin{itemize}
        \item \textbf{市場価格連動プラン}：容量増加に伴い契約電力が増加（430kWh: 205.73kW → 860kWh: 221.56kW → 1290kWh: 226.95kW → 1720kWh: 232.94kW）．価格が安い時間帯により多くの電力を蓄電できるため，買電の集中度が高まる．
        \item \textbf{北海道電力基本プラン}：容量増加に伴い契約電力が減少し収束（430kWh: 189.84kW → 860kWh: 170.93kW → 1290kWh: 161.16kW → 1720kWh: 161.16kW）．1290kWh以上では契約電力が同一値に収束しており，ピークカット効果が飽和している．
    \end{itemize}

    \item \textbf{容量と経済性の関係}：
    \begin{itemize}
        \item \textbf{市場価格連動プラン}：容量増加により年間コストが単調増加．430kWhが最も経済的（15,007,684円）．
        \item \textbf{北海道電力基本プラン}：容量増加により年間コストが減少するが，1290kWh以降は効果が飽和．1720kWhが最も経済的（14,476,495円）だが，1290kWh（14,478,318円）との差はわずか1,823円．
    \end{itemize}

    \item \textbf{最適容量と料金プランの選択}：市場価格連動プランでは小容量（430kWh）が，北海道電力基本プランでは大容量（1290kWh以上）が経済的に有利となった．ただし，北海道電力基本プランでは1290kWhを超えると効果が飽和するため，設備投資対効果を考慮すると1290kWhが実用的な最適容量と考えられる．
\end{enumerate}
