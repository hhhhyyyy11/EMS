...
予測期間$H=96$（48時間）の条件下で，蓄電池容量$b_{\mathrm{F}}^{\max}$を430kWh，860kWh，1290kWhと変化させ，経済性への影響を評価した．
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{市場価格連動プラン}：容量増加に伴い契約電力が増加（430kWh: 205.73kW → 860kWh: 221.56kW → 1290kWh: 226.95kW）．価格が安い時間帯により多くの電力を蓄電できるため，買電の集中度が高まる．
        \item \textbf{北海道電力基本プラン}：容量増加に伴い契約電力が減少（430kWh: 189.84kW → 860kWh: 170.93kW → 1290kWh: 161.16kW）．蓄電池によるピークカット効果が発揮される．
    \end{itemize}

    \item \textbf{容量と経済性の関係}：
    \begin{itemize}
        \item \textbf{市場価格連動プラン}：容量増加により年間コストが増加．430kWhが最も経済的（15,007,684円）．
        \item \textbf{北海道電力基本プラン}：容量増加により年間コストが減少．1290kWhが最も経済的（14,478,318円）．430kWhから1290kWhへの増加で年間約88万円削減．
    \end{itemize}

    \item \textbf{最適容量と料金プランの選択}：市場価格連動プランでは小容量（430kWh）が，北海道電力基本プランでは大容量（1290kWh）が経済的に有利となった．蓄電池容量の最適化は料金プランと密接に関連しており，両者を総合的に検討する必要がある．
\end{enumerate}
